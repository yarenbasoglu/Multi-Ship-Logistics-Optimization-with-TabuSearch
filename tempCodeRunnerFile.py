...
def evaluate_solution(
    ...
    for loc in total_demand.keys():
        gas_sent = delivered_gas[loc]
        diesel_sent = delivered_diesel[loc]
        gas_req = demand_gas[loc]
...
def tabu_search(
    ...
    for it in range(max_iters):
        ...
        for _ in range(neighborhood_size):
            ...
            # %50 rota değiştir, %50 ürün değiştir
            ...
            move = (ship, new_route, new_prod) #bu tabu hareket hangi gemiye uygulandı yeni rota ne oldu ürün neye çevrildi
