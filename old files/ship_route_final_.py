...
# STEP1-2 APPLIED: daily 10-day window skeleton (no assignment)
def run_rolling_horizon_day_loop_step12(
...
def main():
    ...
    plan_logs, unassigned_queue = run_rolling_horizon_day_loop_step12(
    ...
    for rec in plan_logs[:5]:
        print(
            ...
            f"jobs_in_window={len(rec.selected_jobs)} "
